...
I'm Ivan Lima, a data engineer specializing in SQL Server, Azure, and building CI/CD, automation, and AI-ready data platforms. I write here about database modernization — the practical work of getting existing databases into shape to reliably support AI systems: indexing and performance, data engineering pipelines, vector databases, AI semantics, and CI/CD for data platforms.

I also keep an eye on where quantum computing is headed and what it will eventually mean for database design.
